...
public class Question12 {
    ...
    public TreeNode myBuildTree(int[] preorder, int[] inorder) {
        ...
        int[] leftPreorder = subNums(preorder, 1, 1 + index);
        int[] leftInorder = subNums(inorder, 0, index);
        root.left = buildTree(leftPreorder, leftInorder);

        int[] rightPreorder = subNums(preorder, index + 1, preorder.length);
        int[] rightInorder = subNums(inorder, index + 1, inorder.length);
